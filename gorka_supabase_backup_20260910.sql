...
\restrict MCLLqrCL8qIxXUJFS6iDoyBkf5yOcHHKYqb1PVugsqEtemgq4SD4Dr23jp5RzQG
...
--
-- Name: get_default_agent_permissions(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_default_agent_permissions() RETURNS TABLE(permission_name text, default_granted boolean)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY VALUES
...
ALTER FUNCTION public.get_default_agent_permissions() OWNER TO postgres;
...
--
-- Name: agent_assignments; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.agent_assignments (
    ...
    notes text,
    CONSTRAINT agent_assignments_status_check CHECK ((status = ANY (ARRAY['active'::text, 'completed'::text, 'reassigned'::text])))
);
...
CREATE TABLE public.agents (
    ...
    supervisor_id text,
    status text DEFAULT 'active'::text,
    max_debtors integer DEFAULT 50,
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
    CONSTRAINT agents_status_check CHECK ((status = ANY (ARRAY['active'::text, 'inactive'::text, 'suspended'::text])))
);
...
CREATE TABLE public.audit_logs (
    ...
    data_location text DEFAULT 'local-storage'::text,
    created_at timestamp without time zone DEFAULT now()
);
...
CREATE TABLE public.data_uploads (
    ...
    created_at timestamp without time zone DEFAULT now(),
    completed_at timestamp without time zone,
    CONSTRAINT data_uploads_file_type_check CHECK ((file_type = ANY (ARRAY['csv'::text, 'excel'::text, 'json'::text, 'txt'::text]))),
    CONSTRAINT data_uploads_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'processing'::text, 'completed'::text, 'failed'::text])))
);
...
--
-- Name: supervisor_actions; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.supervisor_actions (
    ...
    target_debtor_id text,
    details jsonb,
    created_at timestamp without time zone DEFAULT now()
);


ALTER TABLE public.supervisor_actions OWNER TO postgres;
...
--
-- Data for Name: agent_assignments; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.agent_assignments (id, debtor_id, agent_id, assigned_by, status, assigned_at, completed_at, notes) FROM stdin;
\.


--
-- Data for Name: agent_permissions; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.agent_permissions (id, agent_id, permission, granted, created_at, updated_at) FROM stdin;
\.
...
COPY public.agents (id, user_id, organization_id, supervisor_id, status, max_debtors, created_at, updated_at) FROM stdin;
\.
...
COPY public.audit_logs (id, organization_id, user_id, action, resource, resource_id, details, ip_address, user_agent, compliance_tags, data_location, created_at) FROM stdin;
\.
...
--
-- Data for Name: data_uploads; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.data_uploads (id, organization_id, uploaded_by, filename, file_type, status, records_processed, processing_time, error_log, created_at, completed_at) FROM stdin;
\.
...
--
-- Data for Name: supervisor_actions; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.supervisor_actions (id, organization_id, supervisor_id, action_type, target_agent_id, target_debtor_id, details, created_at) FROM stdin;
\.
...
20211116024918	2026-08-14 11:02:13
20211116045059	2026-08-14 11:02:13
20211116050929	2026-08-14 11:02:13
20211116051442	2026-08-14 11:02:13
20211116212300	2026-08-14 11:02:13
20211116213355	2026-08-14 11:02:13
20211116213934	2026-08-14 11:02:13
20211116214523	2026-08-14 11:02:13
20211122062447	2026-08-14 11:02:13
20211124070109	2026-08-14 11:02:13
20211202204204	2026-08-14 11:02:13
20211202204605	2026-08-14 11:02:13
20211210212804	2026-08-14 11:02:13
20211228014915	2026-08-14 11:02:13
20220107221237	2026-08-14 11:02:13
20220228202821	2026-08-14 11:02:13
20220312004840	2026-08-14 11:02:13
20220603231003	2026-08-14 11:02:13
20220603232444	2026-08-14 11:02:13
20220615214548	2026-08-14 11:02:13
8	add-public-to-buckets	fd670db39ed65f9d08b01db09d6202503ca2bab3	2026-08-14 11:02:24.845035
9	fix-search-function	af597a1b590c70519b464a4ab3be54490712796b	2026-08-14 11:02:24.850412
10	search-files-search-function	b595f05e92f7e91211af1bbfe9c6a13bb3391e16	2026-08-14 11:02:24.857557
11	add-trigger-to-auto-update-updated_at-column	7425bdb14366d1739fa8a18c83100636d74dcaa2	2026-08-14 11:02:24.863246
12	add-automatic-avif-detection-flag	8e92e1266eb29518b6a4c5313ab8f29dd0d08df9	2026-08-14 11:02:24.869728
13	add-bucket-custom-limits	cce962054138135cd9a8c4bcd531598684b25e7d	2026-08-14 11:02:24.877062
14	use-bytes-for-max-size	941c41b346f9802b411f06f30e972ad4744dad27	2026-08-14 11:02:24.883044
15	add-can-insert-object-function	934146bc38ead475f4ef4b555c524ee5d66799e5	2026-08-14 11:02:24.918846
16	add-version	76debf38d3fd07dcfc747ca49096457d95b1221b	2026-08-14 11:02:24.929607
17	drop-owner-foreign-key	f1cbb288f1b7a4c1eb8c38504b80ae2a0153d101	2026-08-14 11:02:24.935001
18	add_owner_id_column_deprecate_owner	e7a511b379110b08e2f214be852c35414749fe66	2026-08-14 11:02:24.940905
19	alter-default-value-objects-id	02e5e22a78626187e00d173dc45f58fa66a4f043	2026-08-14 11:02:24.9486
20	list-objects-with-delimiter	cd694ae708e51ba82bf012bba00caf4f3b6393b7	2026-08-14 11:02:24.954563
21	s3-multipart-uploads	8c804d4a566c40cd1e4cc5b3725a664a9303657f	2026-08-14 11:02:24.962714
22	s3-multipart-uploads-big-ints	9737dc258d2397953c9953d9b86920b8be0cdb73	2026-08-14 11:02:24.992742
23	optimize-search-function	9d7e604cddc4b56a5422dc68c9313f4a1b6f132c	2026-08-14 11:02:25.015389
24	operation-function	8312e37c2bf9e76bbe841aa5fda889206d2bf8aa	2026-08-14 11:02:25.021505
25	custom-metadata	d974c6057c3db1c1f847afa0e291e6165693b990	2026-08-14 11:02:25.028033
26	objects-prefixes	215cabcb7f78121892a5a2037a09fedf9a1ae322	2026-08-14 11:02:25.036261
27	search-v2	859ba38092ac96eb3964d83bf53ccc0b141663a6	2026-08-14 11:02:25.043006
28	object-bucket-name-sorting	c73a2b5b5d4041e39705814fd3a1b95502d38ce4	2026-08-14 11:02:25.048052
29	create-prefixes	ad2c1207f76703d11a9f9007f821620017a66c21	2026-08-14 11:02:25.052917
30	update-object-levels	2be814ff05c8252fdfdc7cfb4b7f5c7e17f0bed6	2026-08-14 11:02:25.057701
31	objects-level-index	b40367c14c3440ec75f19bbce2d71e914ddd3da0	2026-08-14 11:02:25.062497
32	backward-compatible-index-on-objects	e0c37182b0f7aee3efd823298fb3c76f1042c0f7	2026-08-14 11:02:25.067381
33	backward-compatible-index-on-prefixes	b480e99ed951e0900f033ec4eb34b5bdcb4e3d49	2026-08-14 11:02:25.07293
34	optimize-search-function-v1	ca80a3dc7bfef894df17108785ce29a7fc8ee456	2026-08-14 11:02:25.078019
35	add-insert-trigger-prefixes	458fe0ffd07ec53f5e3ce9df51bfdf4861929ccc	2026-08-14 11:02:25.08305
65	objects-key-version-index	603c1c55658e982d35839001e2c2b59a50703904	2026-09-09 08:28:58.582047
66	objects-current-version-index	191466c93aa2c46a00e36505577c5fcab8d7cb4b	2026-09-09 08:28:58.591106
67	objects-null-version-index	15bfe8c35b66642b6c78ba60060fa8793bd2207a	2026-09-09 08:28:58.598242
\.
...
--
-- Name: agent_assignments agent_assignments_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: agent_permissions agent_permissions_agent_id_permission_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.agent_permissions
    ADD CONSTRAINT agent_permissions_agent_id_permission_key UNIQUE (agent_id, permission);
...
--
-- Name: supervisor_actions supervisor_actions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.supervisor_actions
    ADD CONSTRAINT supervisor_actions_pkey PRIMARY KEY (id);
...
--
-- Name: idx_agent_assignments_agent_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_agent_assignments_debtor_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_agent_assignments_debtor_id ON public.agent_assignments USING btree (debtor_id);


--
-- Name: idx_agent_assignments_status; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_agent_permissions_agent_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_agent_permissions_agent_id ON public.agent_permissions USING btree (agent_id);


--
-- Name: idx_agent_permissions_granted; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_agent_permissions_granted ON public.agent_permissions USING btree (granted);
...
--
-- Name: idx_agents_supervisor_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_agents_supervisor_id ON public.agents USING btree (supervisor_id);
...
--
-- Name: idx_data_uploads_created_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_data_uploads_created_at ON public.data_uploads USING btree (created_at);


--
-- Name: idx_data_uploads_organization_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_data_uploads_organization_id ON public.data_uploads USING btree (organization_id);


--
-- Name: idx_data_uploads_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_data_uploads_status ON public.data_uploads USING btree (status);


--
-- Name: idx_supervisor_actions_created_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_supervisor_actions_created_at ON public.supervisor_actions USING btree (created_at);


--
-- Name: idx_supervisor_actions_organization_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_supervisor_actions_organization_id ON public.supervisor_actions USING btree (organization_id);


--
-- Name: idx_supervisor_actions_supervisor_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_supervisor_actions_supervisor_id ON public.supervisor_actions USING btree (supervisor_id);
...
--
-- Name: agent_assignments agent_assignments_agent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: agent_assignments agent_assignments_assigned_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.agent_assignments
    ADD CONSTRAINT agent_assignments_assigned_by_fkey FOREIGN KEY (assigned_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: agent_assignments agent_assignments_debtor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.agent_assignments
    ADD CONSTRAINT agent_assignments_debtor_id_fkey FOREIGN KEY (debtor_id) REFERENCES public.debtors(id) ON DELETE CASCADE;


--
-- Name: agent_permissions agent_permissions_agent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: agents agents_supervisor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.agents
    ADD CONSTRAINT agents_supervisor_id_fkey FOREIGN KEY (supervisor_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.data_uploads
    ADD CONSTRAINT data_uploads_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: supervisor_actions supervisor_actions_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.supervisor_actions
    ADD CONSTRAINT supervisor_actions_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- Name: supervisor_actions supervisor_actions_supervisor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.supervisor_actions
    ADD CONSTRAINT supervisor_actions_supervisor_id_fkey FOREIGN KEY (supervisor_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: supervisor_actions supervisor_actions_target_agent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.supervisor_actions
    ADD CONSTRAINT supervisor_actions_target_agent_id_fkey FOREIGN KEY (target_agent_id) REFERENCES public.agents(id) ON DELETE SET NULL;


--
-- Name: supervisor_actions supervisor_actions_target_debtor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.supervisor_actions
    ADD CONSTRAINT supervisor_actions_target_debtor_id_fkey FOREIGN KEY (target_debtor_id) REFERENCES public.debtors(id) ON DELETE SET NULL;
...
--
-- Name: actions Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON public.actions FOR SELECT TO authenticated USING (true);


--
-- Name: activity_logs Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON public.activity_logs FOR SELECT TO authenticated USING (true);


--
-- Name: ai_feedback Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON public.ai_feedback FOR SELECT TO authenticated USING (true);


--
-- Name: ai_outcomes Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON public.ai_outcomes FOR SELECT TO authenticated USING (true);


--
-- Name: ai_recommendations Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON public.ai_recommendations FOR SELECT TO authenticated USING (true);


--
-- Name: communication_history Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON public.communication_history FOR SELECT TO authenticated USING (true);


--
-- Name: debtors Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON public.debtors FOR SELECT TO authenticated USING (true);


--
-- Name: message_logs Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON public.message_logs FOR SELECT TO authenticated USING (true);


--
-- Name: organizations Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: queue_jobs Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON public.queue_jobs FOR SELECT TO authenticated USING (true);


--
-- Name: supervisor_actions Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON public.supervisor_actions FOR SELECT TO authenticated USING (true);
...
CREATE POLICY "Enable read access for all users" ON public.templates FOR SELECT TO authenticated USING (true);
...
--
-- Name: agent_assignments; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: ai_outcomes; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: communication_history; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.communication_history ENABLE ROW LEVEL SECURITY;

--
-- Name: data_uploads; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.data_uploads ENABLE ROW LEVEL SECURITY;

--
-- Name: debtors; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: queue_jobs; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.queue_jobs ENABLE ROW LEVEL SECURITY;

--
-- Name: supervisor_actions; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_default_agent_permissions(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_default_agent_permissions() TO anon;
GRANT ALL ON FUNCTION public.get_default_agent_permissions() TO authenticated;
GRANT ALL ON FUNCTION public.get_default_agent_permissions() TO service_role;
...
--
-- Name: TABLE agent_assignments; Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON TABLE public.agent_permissions TO anon;
GRANT ALL ON TABLE public.agent_permissions TO authenticated;
...
--
-- Name: TABLE ai_outcomes; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.ai_outcomes TO anon;
GRANT ALL ON TABLE public.ai_outcomes TO authenticated;
...
--
-- Name: TABLE communication_history; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.communication_history TO anon;
GRANT ALL ON TABLE public.communication_history TO authenticated;
GRANT ALL ON TABLE public.communication_history TO service_role;


--
-- Name: TABLE data_uploads; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE debtors; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE queue_jobs; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.queue_jobs TO anon;
GRANT ALL ON TABLE public.queue_jobs TO authenticated;
GRANT ALL ON TABLE public.queue_jobs TO service_role;


--
-- Name: TABLE supervisor_actions; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.supervisor_actions TO anon;
GRANT ALL ON TABLE public.supervisor_actions TO authenticated;
GRANT ALL ON TABLE public.supervisor_actions TO service_role;
...
\unrestrict MCLLqrCL8qIxXUJFS6iDoyBkf5yOcHHKYqb1PVugsqEtemgq4SD4Dr23jp5RzQG
